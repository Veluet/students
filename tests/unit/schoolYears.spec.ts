...
describe("schoolYears.vue", () => {
  it("renders props.msg when passed", () => {
    const siteName = "new message";
    const wrapper = shallowMount(schoolYears, {
      props: { siteName },
    });
